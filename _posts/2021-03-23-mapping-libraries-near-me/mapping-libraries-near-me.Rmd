...
preview: "images/2021-03-20_pratt-library-clifton-branch.jpg"
date: 2021-03-23
categories:
  - mapping
  - R
...
layer_libraries_e <- geom_sf_text(data = libraries_e, aes(label = stringr::str_to_upper(name)), nudge_x = nudge, nudge_y = nudge*-1, angle = -45, hjust = 0)

layer_libraries_nw <- geom_sf_text(data = libraries_nw, aes(label = stringr::str_to_upper(name)), nudge_x = nudge*-1, nudge_y = nudge, angle = -45, hjust = 1) 

layer_libraries_s <- geom_sf_text(data = libraries_s, aes(label = stringr::str_to_upper(name)), nudge_x = nudge*-1, nudge_y = nudge*-1, angle = 45, hjust = 1) 
